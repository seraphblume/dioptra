const CACHE = "dioptra-v0.2.0";
const ASSETS = ["./","./index.html","./css/app.css","./js/config.js","./js/algorithm.js","./js/storage.js","./js/app.js","./manifest.webmanifest","./assets/icon.svg","./assets/icon-192.png","./assets/icon-512.png"];
